...
\item Implementacion caracterisitca Visualizacion Servicios.\\
\begin{center}
...
\item Para implementar esta caracterisitca se utilizo el patron de inyeccion de dependencia para inyectas la constante de configuracion y de esta manera activar las caracteristicas de (Lista,Mosaico o galeria)
\end{itemize}
