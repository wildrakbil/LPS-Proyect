...
\item Configuracion del Aplicacion \\
Para la configuracion del la aplicacion para que tome las caracteristicas a implementar del modelo de variabilidad propuesta se realizo de la siguiente manera: 
\begin{itemize}
\item Constante de configuracion: Se creo una constante en la aplicacion que tendria un objecto con la propiedades variables del producto a generar. Tanto en atributos como en caracteristicas, como se muestra en la siguiente figura:

\includegraphics[width=0.8\textwidth]{oc_4}

\item Implementacion caracterisitca Visualizacion Servicios: Para implementar esta caracterisitca se utilizo el patron de inyeccion de dependencia para inyectas la constante de configuracion y de esta manera activar las caracteristicas de (Lista,Mosaico o galeria). Asi como se muestra en la siguiente figura:

\includegraphics[width=0.8\textwidth]{oc_5}

\includegraphics[width=0.8\textwidth]{oc_6}

\item Implementacion variablidad en atributos: Los atributos con variablidad son el: Nombre del taller, direccion, telefono , pagina web y logo. Para implementar esta variabilidad se utilizo el patron de inyeccion de dependencia para inyectar la constante de configuracion y asi utilizar las variables de estos atributos como se muestra en la siguiente figura:
