...
\includegraphics[width=0.4\textwidth]{dn_3}
\end{center}
...
Permitiendo al usuario visualización de servicios: Lista,Mosaico o Galería, según sea el producto.

\item Implementación característica Inicio de Sesión.\\
\begin{center}
\includegraphics[width=0.8\textwidth]{dn_1}
