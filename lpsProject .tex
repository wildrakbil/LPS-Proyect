...
\begin{longtable}{|p{1cm}|p{1cm}|p{1cm}|p{0.6cm}|p{4.6cm}|p{1cm}|p{0.8cm}|p{1cm}|p{2cm}|p{1cm}|} \hline
  ...
  RFU& 
  0.1 & 
  El sistema de Tallers WEB podrá proveer a los administradores gestionar los servicios ofrecidos  & 
  Cliente & 
  True &
  0-5 &
  29/11/2020 &
  ...
  RFU& 
  0.1 & 
  El sistema de Tallers WEB podrá proveer a los administradores gestionar los Horarios de atencion al publico  & 
  Cliente & 
  True &
  0-5 &
  29/11/2020 &
